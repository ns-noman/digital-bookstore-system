...
return [
    "sandbox"         => env("NAGAD_SANDBOX", false),
    ...
    /*
      ...
      */
    "callback_url"    => env("NAGAD_CALLBACK_URL", "https://paperproc.com/nagad/callback"),
    "callback_url_2"    => env("NAGAD_CALLBACK_URL2", "https://paperproc.com/nagad/callback"),
    "callback_url_3"    => env("NAGAD_CALLBACK_URL3", "https://paperproc.com/nagad/callback"),
    "callback_url_4"    => env("NAGAD_CALLBACK_URL4", "https://paperproc.com/nagad/callback"),
