                            ...
                            @endforeach
                              ...
                              <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <label class="control-label">{{\App\CPU\translate('Product ID')}}</label>
                                        <input type="text" name="product_uid" placeholder="Product ID" value="{{$product['product_uid']}}" class="form-control">
                                    </div>
    
                                    <div class="col-md-12 mb-4">
                                        <label class="control-label">{{\App\CPU\translate('Quick Overview')}}</label>
                                        <textarea rows="5" type="text" name="quick_overview" class="form-control editor textarea">{{$product['quick_overview']}}</textarea>
                                    </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                               ...
                               <div class="col-md-3 mb-4">
                                    <label class="control-label">{{\App\CPU\translate('Package Weight')}}</label>
                                    <input type="text" name="weight" placeholder="Weight" value="{{$product['weight']}}" class="form-control">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label class="control-label">{{\App\CPU\translate('length')}}</label>
                                    <input type="text" name="length" placeholder="Length"  value="{{$product['length']}}" class="form-control">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label class="control-label">{{\App\CPU\translate('Width')}}</label>
                                    <input type="text" name="width" placeholder="Width" value="{{$product['width']}}" class="form-control">
                                </div>
                                <div class="col-md-3 mb-4">
                                    <label class="control-label">{{\App\CPU\translate('Height')}}</label>
                                    <input type="text" name="height" placeholder="Height" value="{{$product['height']}}" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
