                                        ...
                                        <div id="collapseThree"
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="">{{ \App\CPU\translate('contact_person_name')}}
                                                        <span style="color: red">*</span></label>
                                                    <input type="text" class="form-control"
                                                           name="contact_person_name" {{$shipping_addresses->count()==0?'required':''}}>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">{{ \App\CPU\translate('Phone')}}
                                                        <span
                                                ...
                                                <div class="form-group">
                                                    <label  for="">{{ \App\CPU\translate('address')}} {{ \App\CPU\translate('Type')}}</label>
                                                ...
                                                <div class="form-group">
                                                    <label>{{ \App\CPU\translate('Country')}} <span
                                                            style="color: red">*</span></label>
                                                    <select name="country" id="country" class="form-control" {{$shipping_addresses->count()==0?'required':''}}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="city" id="city" class="form-control" {{$shipping_addresses->count()==0?'required':''}}>
                                                    <option value="">Select City</option>
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->en_name }}">{{ $city->en_name }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div id="billing_model"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label>{{ \App\CPU\translate('Country')}} <span
                                                            style="color: red">*</span></label>
                                                    <select name="billing_country" id="billing_country" class="form-control" {{$billing_addresses->count()==0?'required':''}}>
                                                        <option value="">Select Country</option>
                                                        @foreach ($countries as $country)
                                                            <option value="{{ $country->en_name }}">{{ $country->en_name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="billing_city" id="billing_city" class="form-control" {{$billing_addresses->count()==0?'required':''}}>
                                                    <option value="">Select City</option>
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->en_name }}">{{ $city->en_name }}</option>
                                                    @endforeach
