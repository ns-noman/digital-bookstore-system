...
<head>
    ...
    <meta name="google-site-verification" content="1QVPEFXpcy2uHUNwebwO_XCUYUzib7pEw5j-jy9lrPE" />    
   ...
   <style>
        ...
        .mobile-overlay-bottom > div{
            text-align: center;
        }
        .mobile-overlay-bottom > div > a{
            display: block;
            color: #484848;
        }

        .mobile-overlay-bottom > div > a p{
            font-weight: 500;
            margin: 0;
            font-size: 9px;
        }
        .mobile-overlay-bottom > div > a.active-menu-m{
            color: orangered;
        }

        .mobile-overlay-bottom a i{
            font-size: 14px;
            line-height: 10px;
        }
    </style>
...
<body class="toolbar-enabled">
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "100862599567975");
 ...
 <!--   <audio autoplay="true" src="{{ asset('public/assets/videos/playsound.mp3') }}">-->
...
<script src="{{asset('public/assets/front-end')}}/js/whatsAppChatBuilder.js"></script>
<script>
