        ...
        <div class="row" style="direction: ltr">
            ...
            <div class="col-lg-5 col-md-5 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                <div class="details">
                    ...
                    <div class="mb-3">
                        <strong>{{\App\CPU\translate('Product ID')}} : </strong>
                        <strong id="">{{ $product->product_uid }}</strong>
                    </div>
                    <div class="mb-3">
                        <strong>{{\App\CPU\translate('Quick Overview')}} : </strong>
            ...
            <div class="col-md-2 col-lg-2 col-sm-2">
                <div class="details">
                     <div class="mb-3 border-bottom">
                         ...
                         <p>Inside Dhaka  <span class="pull-right">- 70 tk</span></p>
                         <p>Outside Dhaka  <span class="pull-right">- 120 tk</span></p>
                     </div>
