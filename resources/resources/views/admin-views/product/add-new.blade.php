                            ...
                            @endforeach
                             ...
                             <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="product_uid" placeholder="Product ID" class="form-control">
                                </div>

                                <div class="col-md-12 mb-4">
                                    <label class="control-label">{{\App\CPU\translate('Quick Overview')}}</label>
                                    <textarea rows="5" type="text" name="quick_overview" class="form-control editor textarea"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="name">{{\App\CPU\translate('Writter')}}</label>
                                        <select
