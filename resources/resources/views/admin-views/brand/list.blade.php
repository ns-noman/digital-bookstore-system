...
@section('title', \App\CPU\translate('Writter List'))
@push('css_or_js')
@endpush
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">{{\App\CPU\translate('Writter List')}} <span style="color: rgb(252, 59, 10);">({{ $br->total() }})</span></h1>
        </div>
                        ...
                        <form action="{{ url()->current() }}" method="GET">
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ \App\CPU\translate('Search')}} {{ \App\CPU\translate('Writter')}}" aria-label="Search orders" value="{{ $search }}" required>
                    ...
                    <div class="card-body" style="padding: 0">
                        <div class="table-responsive">
                            <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                ...
                                <tr>
                                    <th scope="col" style="width: 100px">{{ \App\CPU\translate('Writter')}} {{ \App\CPU\translate('ID')}}</th>
