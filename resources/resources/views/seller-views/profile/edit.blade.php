                ...
                <!-- Card -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('NID Number')}}</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nid_number" id="nid_number"
                                           value="{{$data->nid_number}}"
                                           placeholder="{{\App\CPU\translate('Enter your NID Number')}}" aria-label="Enter your NID Number">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        ...
                                        <a href="{{asset('storage/app/public/seller')}}/{{$data->nid_front}}">NID Front Page Preview</a>
                                        <br>
                                        <input type="file" name="nid_front" id="" class="" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class=""
                                               for="">{{\App\CPU\translate('NID Front Page ')}} {{\App\CPU\translate('Upload')}}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        <a href="{{asset('storage/app/public/seller')}}/{{$data->nid_back}}">NID Back Page Preview</a>
                                        <br>
                                        <input type="file" name="nid_back" id="" class="" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="" for="">{{\App\CPU\translate('NID Back Page')}} {{\App\CPU\translate('Upload')}}</label>
                                    </div>
                                </div>
                            </div>
