                        ...
                        <form action="{{route('seller.profile.bank_update',[$data->id])}}" method="post"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name">{{\App\CPU\translate('Bank Routing Number')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="bank_routing" value="{{$data->bank_routing}}" class="form-control"
                                               id="name"
                                               required>
                                    </div>
                                </div>
