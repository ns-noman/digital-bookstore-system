...
class ProductController extends BaseController
{
    ...
    public function mall_status(Request $request)
    {
        $product = Product::find($request->id);
        $product->mall_status = ($product['mall_status'] == 0 || $product['mall_status'] == null) ? 1 : 0;
        $product->save();
        $data = $request->status;
        return response()->json($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $p->unit = $request->unit;
        $p->product_uid         = $request->product_uid;
        $p->quick_overview      = $request->quick_overview;
