...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'country','as' => 'country.'], function () {
            Route::get('add-new', 'CountryController@add_new')->name('add-new');
            Route::post('add-new', 'CountryController@store');
            Route::get('list', 'CountryController@list')->name('list');
            Route::get('update/{id}', 'CountryController@edit')->name('update');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('mall-status', 'ProductController@mall_status')->name('mall-status');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('generate_slip/{id}', 'OrderController@generate_slip')->name('generate-slip');
